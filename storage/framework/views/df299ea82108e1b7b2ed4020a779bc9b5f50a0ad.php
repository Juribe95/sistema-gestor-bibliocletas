    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <form>
                        ...
                        <div class="form-row">
                            <center><button type="submit" class="btn btn-primary">Modificar Libro</button></center>
...
<?php echo $__env->make('Plantilla-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sgb\resources\views/editar-libro.blade.php ENDPATH**/ ?>
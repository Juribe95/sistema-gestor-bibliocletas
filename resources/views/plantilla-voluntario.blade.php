...
<!-- Sidebar -->
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
        ...
        <i class="fa fa-remove">l</i>
            ...
            <a class="w3-bar-item w3-button w3-hover-black" href="{{ route('inicio-voluntario') }}">Inicio</a>
            <a class="w3-bar-item w3-button w3-hover-black" href="">Administrar Pedidos</a>
            <a class="w3-bar-item w3-button w3-hover-black" href="">Pedidos Tomados</a>
